...
void Test_Pin_init()
{
	...
	ioport_set_pin_dir(TEST_PIN_4, IOPORT_DIR_OUTPUT);
	ioport_set_pin_dir(TEST_PIN_5, IOPORT_DIR_OUTPUT);
	ioport_set_pin_dir(TEST_PIN_6, IOPORT_DIR_OUTPUT);
	ioport_set_pin_dir(TEST_PIN_7, IOPORT_DIR_OUTPUT);
	ioport_set_pin_dir(TEST_PIN_8, IOPORT_DIR_OUTPUT);
}
*/

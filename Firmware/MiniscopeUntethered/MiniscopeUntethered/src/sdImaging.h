...
#define PYTHON480
	...
	#define POTENTIOMETER_ADR		0x50 // 0b 0101 0000
	#define EWL_DRIVER_ADR			0x77 // 0b 0111 0111
	#define HE_EWL_DRIVER_ADR		0x23 // 0b 0010 0011

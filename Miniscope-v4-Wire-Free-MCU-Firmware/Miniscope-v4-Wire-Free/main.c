...
// Enable push button cb to start recording: Replaced the push button with the IR to start the recording
// Add blinking status: Done. Different blinking for charging the battery, battery fully charged and delay for starting the recording
// Set up IR communication: Partially done. Currently the IR just triggers the start of recording without decoding NEC

...
void HAL_DCMI_MspInit(DCMI_HandleTypeDef* hdcmi)
{
  ...
  /* USER CODE END DCMI_MspInit 0 */
    ...
    PD8     ------> DCMI_HSYNC
    */
    GPIO_InitStruct.Pin = GPIO_PIN_1|GPIO_PIN_4|GPIO_PIN_0;
...
void HAL_DCMI_MspDeInit(DCMI_HandleTypeDef* hdcmi)
{
  ...
  /* USER CODE END DCMI_MspDeInit 0 */
    ...
    PD8     ------> DCMI_HSYNC
    */
    HAL_GPIO_DeInit(GPIOE, GPIO_PIN_1|GPIO_PIN_4|GPIO_PIN_0);

    HAL_GPIO_DeInit(GPIOB, GPIO_PIN_8|GPIO_PIN_9|GPIO_PIN_7|GPIO_PIN_6);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI1_MspDeInit 0 */
    ...
    PB5     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(GPIOB, GPIO_PIN_4|GPIO_PIN_3|GPIO_PIN_5);
